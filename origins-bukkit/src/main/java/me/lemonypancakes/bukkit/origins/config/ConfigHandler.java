 ...
 */
package me.lemonypancakes.bukkit.origins.config;

import me.lemonypancakes.bukkit.common.com.tchristofferson.configupdater.ConfigUpdater;
...
public class ConfigHandler {
    ...
    public ConfigHandler(OriginsBukkitPlugin plugin) {
        this.plugin = plugin;
        init();
    }
