...
public class CraftSelfGlowPower extends CraftPower {
    ...
    public CraftSelfGlowPower(OriginsBukkitPlugin plugin, Identifier identifier, JsonObject jsonObject, boolean isFactory) {
    ...
    public Power newInstance(OriginsBukkitPlugin plugin, Identifier identifier, JsonObject jsonObject) {
        return new CraftSelfGlowPower(plugin, identifier, jsonObject, false);
    }
}
