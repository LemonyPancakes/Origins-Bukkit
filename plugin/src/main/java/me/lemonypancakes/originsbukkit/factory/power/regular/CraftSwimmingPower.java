...
public class CraftSwimmingPower extends CraftPower {
    ...
    public CraftSwimmingPower(OriginsBukkitPlugin plugin, Identifier identifier, JsonObject jsonObject, boolean isFactory) {
    ...
    public Power newInstance(OriginsBukkitPlugin plugin, Identifier identifier, JsonObject jsonObject) {
        return new CraftSwimmingPower(plugin, identifier, jsonObject, false);
    }
